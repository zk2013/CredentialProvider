...
#define SVCNAME TEXT("CredentialService")

SERVICE_STATUS          gSvcStatus;
SERVICE_STATUS_HANDLE   gSvcStatusHandle;
HANDLE                  ghSvcStopEvent = NULL;
HANDLE					hThreadServer = NULL;
...
VOID SvcDelete()
{
	...
	hService = OpenService(schSCManager, SVCNAME, SERVICE_STOP | DELETE);
...
VOID SvcStart()
{
	...
	hService = OpenService(schSCManager, SVCNAME, SERVICE_START);
...
VOID WINAPI SvcMain(DWORD dwArgc, LPTSTR *lpszArgv)
{
	...
	plog::init(plog::debug, "C:\\LogService.txt", 50000, 1);
